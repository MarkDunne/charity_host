    ...
    publicMethods = {
        pushTag : function (tag, ignoreEvents, externalTagId) {
            ...
            if (alreadyInList) {
                ...
                // html = '<span class="' + "label label-primary" + '" id="' + newTagId + '">';
                // html+= '<span>' + escaped + '</span>';
                // html+= '<a href="#" class="tm-tag-remove" id="' + newTagRemoveId + '" TagIdToRemove="' + tagId + '">';
                // html+= '<span class="glyphicon glyphicon-remove"></span>' + '</a></span> ';
                // $el = $(html);

                html = '<span id="' + newTagId + '" class="tm-tag">';
                html += '<button type="button" href="#" class="btn btn-primary tm-tag-remove" id="' + newTagRemoveId + '" TagIdToRemove="' + tagId + '">';
                html += escaped + '<span class="glyphicon glyphicon-remove"></span>';
                html += '</button></span>';
                $el = $(html);
